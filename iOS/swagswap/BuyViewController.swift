...
class BuyViewController: UICollectionViewController {
    
    let parseClassName: String = "Offer"
    ...
    func loadObjects() {
        ...
        query.findObjectsInBackgroundWithBlock { (objects: [AnyObject]?, error: NSError?) -> Void in
            ...
            let offers: [Offer] = objects as! [Offer]
            
            self.listings = (offers as NSArray).valueForKeyPath("@distinctUnionOfObjects.listing") as! [Listing]
