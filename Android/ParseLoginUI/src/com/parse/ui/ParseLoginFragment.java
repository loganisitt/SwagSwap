...
private Bitmap getProPic(URL imageUrl){
    Bitmap image = null;
    DefaultHttpClient client = new DefaultHttpClient();
    HttpGet request = new HttpGet(String.valueOf(imageUrl));
    try {
                              ...
                              if (fbUser != null && parseUser != null
                                      && fbUser.getName().length() > 0) {
                                          ...
                                          try {
                                              ...
                                              byte[] propbit = stream1.toByteArray();
                                              ParseFile saveImageFile = new ParseFile("Picture.jpg", propbit);
                                              parseUser.put("picture",saveImageFile);
                                              bis.close();
                                              is.close();
